    ...
    public class VertexSteps
    {
        ...
        public void Steps_Vertex_Out()
        {
            using (var client = TestDatabase.GetClient("steps_vertex_out"))
            {
                ...
                Assert.AreEqual(client.Execute(VertexQuery.All().HasLabel("one").Out()).Result.First().label, "two");
            }
        }
        ...
        public void Steps_Vertex_In()
        {
            ...
            {
                Setup_Test_Database(client);
                Assert.AreEqual(client.Execute(VertexQuery.All().HasLabel("two").In()).Result.First().label, "one");
            }
        }
        ...
        public void Steps_Vertex_Both()
        {
            using (var client = TestDatabase.GetClient("steps_vertex_both"))
            {
                ...
                Assert.IsTrue(result.ToList().Exists(v => v.label == "one"));
                Assert.IsTrue(result.ToList().Exists(v => v.label == "three"));
            }
        }
        ...
        public void Steps_Vertex_OutE()
        {
            ...
            {
                Setup_Test_Database(client);
                Assert.AreEqual(client.Execute(VertexQuery.All().HasLabel("one").OutE()).Result.First().label, "one_to_two");
            }
        }
        ...
        public void Steps_Vertex_InE()
        {
            ...
            {
                Setup_Test_Database(client);
                Assert.AreEqual(client.Execute(VertexQuery.All().HasLabel("two").InE()).Result.First().label, "one_to_two");
            }
        }
        ...
        public void Steps_Vertex_InV()
        {
            ...
            {
                Setup_Test_Database(client);
                Assert.AreEqual(client.Execute(VertexQuery.All().HasLabel("two").OutE().InV()).Result.First().label, "three");
            }
        }
        ...
        public void Steps_Vertex_BothV()
        {
            using (var client = TestDatabase.GetClient("steps_vertex_bothV"))
            {
                ...
                Assert.AreEqual(result.Count(), 2);
                Assert.IsTrue(result.ToList().Exists(v => v.label == "two"));
                Assert.IsTrue(result.ToList().Exists(v => v.label == "three"));
            }
        }
        ...
        public void Steps_Vertex_OtherV()
        {
            ...
            {
                Setup_Test_Database(client);
                Assert.AreEqual(client.Execute(VertexQuery.All().HasLabel("two").OutE().OtherV()).Result.First().label, "three");
            }
        }
